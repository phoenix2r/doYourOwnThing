        ...
        <div className="guidance">
          ...
          <div className="controls">
            <div className="playback-buttons">
              <button id="play"><i className="fas fa-play fa-lg"></i></button>
              <button id="pause"><i className="fas fa-pause fa-lg"></i></button>
            </div>
            <div className="progress-bar">
              <div className="blue-bar"></div>
            </div>
            <div className="environment-buttons">
              <button id="volume"><i className="fas fa-volume-off fa-lg"></i></button>
              <button id="screen-toggle"><i className="fas fa-desktop fa-lg"></i></button>
            </div>
          </div>
        </div>
      </section>
